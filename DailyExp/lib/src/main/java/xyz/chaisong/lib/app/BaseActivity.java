...
import xyz.chaisong.lib.app.lifecycle.IComponentContainer;
import xyz.chaisong.lib.app.lifecycle.LifeCycleComponent;
import xyz.chaisong.lib.app.lifecycle.LifeCycleComponentManager;
...
public abstract class BaseActivity extends AppCompatActivity implements IComponentContainer {
    ...
    public void finish() {
        if (swipeFinished) {
            ...
            if (swipeEnabled) swipeLayout.cancelPotentialAnimation();
            super.finish();
    ...
    public void startActivity(Intent intent) {
        ...
        AppEnum.ActivityAnim curActivityAnim = (AppEnum.ActivityAnim) intent.getSerializableExtra(KEY_ActivityAnim);
        if (curActivityAnim != null) {
            configActivityAnim(curActivityAnim, true);
        }
    }

    private void configActivityAnim(AppEnum.ActivityAnim eActivityAnim, boolean isIn) {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (swipeEnabled) swipeLayout.replaceLayer(this);
    }
    ...
    class SwipeLayout extends FrameLayout {
        ...
        public void replaceLayer(Activity activity) {
            ...
            mActivity = activity;
            screenWidth = LocalDisplay.SCREEN_WIDTH_PIXELS;
            setClickable(true);
